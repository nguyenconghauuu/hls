            ...
            <div class="row">
                <form action="" method="POST" style="width: 50%; margin: 0 auto" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input style="height: 50px;"  name="u_email" value="{{ $user->u_email }}" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                               placeholder="Nhập email">

                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Họ và tên</label>
                        <input style="height: 50px;" class="form-control" name="u_name" value="{{ $user->u_name }}" type="text" placeholder="Nhập họ và tên">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Tuổi</label>
                        <input style="height: 50px;" class="form-control" name="u_age" value="{{ $user->u_age }}" type="number" >
                    </div>
