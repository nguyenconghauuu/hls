...
<div class="main">
    ...
    <div class="container shadow p-3 mb-5 bg-white rounded" style="background-color: whitesmoke;">
        <div class="content">
            <h2 style="text-align: center"> Điền email tài khoản </h2>
            @if(session('message'))
            ...
            <div class="row">
                <form action="" method="POST" style="width: 50%; margin: 0 auto" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input style="height: 50px;"  required name="email" value="" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                               placeholder="Email đăng nhập ....">

                    </div>
                    <button style="width: 100%;height: 50px;border-radius: 30px;" type="submit" class="btn btn-primary">Xác nhận</button>
                </form>
            </div>
        </div>
    </div>
