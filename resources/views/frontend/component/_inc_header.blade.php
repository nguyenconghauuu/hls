    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div  class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto" style="margin:  0 auto;justify-content: space-between">
                ...
                <form class="form-inline my-2 my-lg-0" action="{{ route('searchTypehead') }}" style="margin:0px 100px 0 0 ;">
                    <input class="form-control mr-sm-2" style="width:300px" type="search" name="k" placeholder="Tim kiem"
                ...
                @if(Auth::guard('web')->check())
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="padding: 10px">
                            <li><a href="{{ route('get.profile') }}"> Cập nhật thông tin </a></li>
                            <li><a href="{{ route('get.password') }}"> Cập nhật mật khẩu </a></li>
                            <li><a href="{{ route('get.kq.list') }}"> Kết quả bài thi</a></li>
